...
public class GetAllNotifications: NSCoding {
  ...
  */
  public init(json: JSON) {
    ...
    if let items = json[kGetAllNotificationsDataKey].array { data = items.map { NotiData(json: $0) } }
  }
  ...
  */
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: kGetAllNotificationsDataKey) as? [NotiData]
  }
